...
<body>
	<form action="EventBoardRegisSubmit" method="get">
		...
		<div>
			...
			시작일 <input type="date" name="event_start_date" class="checkDate" id="eventStartDateSchedule" required><br>
			종료일 <input type="date" name="event_end_date" class="checkDate" id="eventEndDateSchedule"required><br>
